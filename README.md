...
Drop an image file into this repo and open a pull request. The CI pipeline will automatically convert it to the correct format (100×100, black and white) and sync it into the main app.
